...
label arc_escape:
    ...
    arceus "Yeah, so much for the tech job, I guess."
    ...
    cs "It IS hell."
    arceus "I should've known that the cops were gonna look for us. We didn't hide our tracks too well."
    arceus "I heard about the cops at the last second when I was checking comms around the area, and I figured that since you helped me out, I should come back for you."
    cs "Thanks man, I really owe you again."
    arceus "Nah, I owe you."
    n "CS and Arc approach the border guard again."
    border_guard "I'm gonna need prove of-"
    ...
    arceus "Well, I've been at the same hotel, trying to get my life back on track."
    arceus "I've been in prison for 5 years, so I've had to figure out what to do again."
    ...
    arceus "No idea, I'm just following the road. We have to find a rest stop here anytime soon."
