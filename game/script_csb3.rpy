...
label edit_video:
    ...
    cs "For tonight, this is CS, signing out!"
    ...
    cs "It will be perfect! No one will expect it because they probably don't even know what I even did with my life for the past 9 years!"
    cs "As always, I should make sure it's as good as possible so at least Linus will enjoy it along with his fans."
    cs "But I also have so much time before Linus comes back and notices, so I need to hurry!"
