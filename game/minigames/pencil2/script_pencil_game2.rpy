    ...
    class Pencil2GameDisplayable(renpy.Displayable):
        def __init__(self):
            ...
            if fun_value(FUN_VALUE_COMMON):
                self.current_pencil = Image("minigames/pencil/pencilcolor.png")
            else:           
        ...
        def render(self, width, height, st, at):
            ...
            count_renderer = renpy.render(Text( _(str(PENCIL_LIMIT2 - self.pencils) + " pencils remaining"), color = "#FF0000", size = 72), 1000, 100, st, at)
