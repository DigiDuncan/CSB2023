...
class Characters:
    ...
    CS_VS_TATE_PUNCH = Character("{image=gui/inline_text/dx.png} CS (VS Tate - Punch)", 288, 10, 40, [Attacks.PUNCH, Attacks.GENERGY, Attacks.YTP_MAGIC], portrait=Image("gui/rpg_common/portraits/cs.png"), display_name = "CS", ai = AIType.NEUTRAL, sprite=Image("images/characters/cs/base/angry.png"))
    CS_VS_TATE_KICK = Character("{image=gui/inline_text/dx.png} CS (VS Tate - Kick)", 288, 10, 40, [Attacks.KICK, Attacks.GENERGY, Attacks.YTP_MAGIC], portrait=Image("gui/rpg_common/portraits/cs.png"), display_name = "CS", ai = AIType.NEUTRAL, sprite=Image("images/characters/cs/base/angry.png"))
    CS_VS_TATE_CHOP = Character("{image=gui/inline_text/dx.png} CS (VS Tate - Chop)", 288, 10, 40, [Attacks.CHOP, Attacks.GENERGY, Attacks.YTP_MAGIC], portrait=Image("gui/rpg_common/portraits/cs.png"), display_name = "CS", ai = AIType.NEUTRAL, sprite=Image("images/characters/cs/base/angry.png"))
    ...
    LAD = Character("{image=gui/inline_text/dx.png} Lad", 100, 10, 12, [Attacks.STRUGGLE_BUG, Attacks.GROWL, Attacks.BUG_BITE, Attacks.METRONOME], portrait=Image("gui/rpg_common/portraits/lad.png"), sprite=Image("images/characters/lad/default.png"), ai = AIType.SKITTISH, display_name="Lad")
    ...
    OBAMA = Character("{image=gui/inline_text/dx.png} Obama", 190, 25, 35, [Attacks.KARATE_CHOP, Attacks.DRONE_STRIKE], portrait=Image("gui/rpg_common/portraits/obama.png"), sprite=Image("images/characters/obama/obama.png"), ai = AIType.SMART, display_name = "Obama")
    CASHIER = Character("{image=gui/inline_text/dx.png} Cashier", 188, 14, 33, [Attacks.COIN_BARRAGE, Attacks.CART_SMASH], portrait=Image("gui/rpg_common/portraits/cashier.png"), sprite=Image("images/characters/cashier.png"), ai = AIType.NEUTRAL, display_name = "Cashier")
    SHARK = Character("{image=gui/inline_text/dx.png} Shark", 190, 10, 40, [Attacks.BITE, Attacks.SHARKNADO], portrait=Image("gui/rpg_common/portraits/shark.png"), sprite=Image("images/characters/blahaj_shark.png"), ai = AIType.AGGRO, display_name = "Shark")
    ...
    COPGUY_EXE = Character("{image=gui/inline_text/dx.png} Copguy.EXE", 666, 66, 66, [Attacks.ELDRITCH_BLAST, Attacks.RAINBOW_VOMIT, Attacks.SLASH, Attacks.LIFE_STEAL], sprite=Image("images/characters/copguy/copguyexe.png"), ai = AIType.AGGRO, display_name = "Copguy.EXE", portrait=Image("gui/rpg_common/portraits/copguy_exe.png"))
    ...
    TATE_EX = Character("{image=gui/inline_text/dx.png} Tate EX", 9999, 11, 111, [Attacks.DAMAGE_SCREM, Attacks.REVERB_RECALL, Attacks.ECHO_BLAST], sprite=Image("images/characters/tate/secret/tate_ex.png"), ai = AIType.AGGRO, display_name = "Tate EX", portrait=Image("gui/rpg_common/portraits/tate_ex.png"), anim_sprite="tate_ex", custom_health_bar = "hp_bar_secret_t")

    # Enemies (UCN)
    WESLEY = Character("{image=gui/inline_text/dx.png} Wesley", 200, 20, 40, [Attacks.PISTOL, Attacks.ALL_OVER_AGAIN], sprite=Image("images/characters/hohsis/wesley.png"), ai = AIType.AGGRO, display_name = "Wesley", portrait=Image("gui/rpg_common/portraits/wesley.png"))
    ED = Character("{image=gui/inline_text/dx.png} Ed", 300, 30, 25, [Attacks.HEAVY_PUNCH, Attacks.SOTH], sprite=Image("images/characters/hohsis/ed.png"), ai = AIType.SMART, display_name = "Ed", portrait=Image("gui/rpg_common/portraits/ed.png"))
    RICHARD = Character("{image=gui/inline_text/dx.png} Richard", 250, 20, 30, [Attacks.ONE_HUNDRED, Attacks.ICE_CREAM], sprite=Image("images/characters/hohsis/rich.png"), ai = AIType.DEFENSIVE, display_name = "Richard", portrait=Image("gui/rpg_common/portraits/rich.png"))
    CEO = Character("{image=gui/inline_text/dx.png} CEO of Diabetes", 1000, 50, 75, [Attacks.LOBBYING, Attacks.NANOMACHINES], sprite=Image("images/characters/ceo.png"), ai = AIType.SMART, display_name = "CEO", portrait=Image("gui/rpg_common/portraits/diabetes_ceo.png"))
    SECRETARY = Character("{image=gui/inline_text/dx.png} Secretary of Diabetes", 1000, 50, 75, [Attacks.LOBBYING, Attacks.NANOMACHINES], sprite=Image("images/characters/secretary.png"), ai = AIType.SMART, display_name = "Secretary", portrait=Image("gui/rpg_common/portraits/diabetes_secretary.png"))
    SANDBAG = Character("{image=gui/inline_text/ucn.png} Sandbag", math.inf, 100, 0, [Attacks.DO_NOTHING], sprite=Image("images/characters/sandbag.png"), ai = AIType.DEFENSIVE, display_name = "Sandbag", portrait=Image("gui/rpg_common/portraits/sandbag.png"))
