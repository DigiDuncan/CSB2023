...
class Characters:
    ...
    BLANK = Character("Blank", 180, 5, 35, [Attacks.SAMPLE_BLAST, Attacks.GNOMED], portrait=Image("gui/rpg/portraits/blank_hover.png"))
    ...
    # Allies (UCN)
    BUBBLE = Character("{image=gui/inline_text/dx_text.png} Bubble", 250, 10, 35, [Attacks.STOMP, Attacks.POKE], display_name = "Bubble", portrait=Image("gui/rpg/portraits/bubble.png"))
    GES = Character("{image=gui/inline_text/dx_text.png} Ges", 170, 20, 35, [Attacks.SWORD_SLASH, Attacks.FLAMETHROWER], display_name = "Ges", portrait=Image("gui/rpg/portraits/ges.png"))
    MICHAEL = Character("Michael", 155, 15, 35, [Attacks.CHOCOLATE_CAKE, Attacks.CONFUSING_STORY], portrait=Image("gui/rpg/portraits/michael.png"))
    BILLY = Character("Billy", 220, 10, 25, [Attacks.HYPE_UP, Attacks.PITCHMAN, Attacks.AUGMENT], portrait=Image("gui/rpg/portraits/billy.png"))
    PHIL = Character("Phil", 160, 20, 40, [Attacks.HYPE_UP, Attacks.PITCHMAN], portrait=Image("gui/rpg/portraits/phil.png"))
    MEAN = Character("Mean", 150, 20, 35, [Attacks.HUG, Attacks.SPIKE_BOMB], portrait=Image("gui/rpg/portraits/mean.png"))
    POMNI = Character("Pomni", 200, 15, 30, [Attacks.RAINBOW_VOMIT_NOCOOL, Attacks.RAINBOW_VOMIT_NOCOOL], portrait=Image("gui/rpg/portraits/pomni.png"))
    OBAMA = Character("{image=gui/inline_text/dx_text.png} Obama", 190, 25, 35, [Attacks.KARATE_CHOP, Attacks.DRONE_STRIKE], portrait=Image("gui/rpg/portraits/obama.png"))
    CASHIER = Character("{image=gui/inline_text/dx_text.png} Cashier", 188, 14, 33, [Attacks.COIN_BARRAGE, Attacks.CART_SMASH], portrait=Image("gui/rpg/portraits/cashier.png"))
    SHARK = Character("{image=gui/inline_text/dx_text.png} Shark", 190, 10, 40, [Attacks.BITE, Attacks.SHARKNADO], portrait=Image("gui/rpg/portraits/shark.png"))
