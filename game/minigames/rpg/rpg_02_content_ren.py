...
class Characters:
    ...
    BLANK = Character("Blank", 180, 10, 30, [Attacks.SAMPLE_BLAST, Attacks.GNOMED], portrait=Image("gui/rpg/portraits/blank.png"), sprite=Image("images/characters/blank.png"), ai = AIType.DEFENSIVE)
    ...
    MICHAEL = Character("Michael", 155, 15, 35, [Attacks.CHOCOLATE_CAKE, Attacks.CONFUSING_STORY, Attacks.BEDTIME_STORY], portrait=Image("gui/rpg/portraits/michael.png"), sprite=Image("images/characters/michael.png"), ai = AIType.DEFENSIVE)
    ...
    COPGUYGODMODE = Character("Copguy (God)", math.inf, 100, 35, [Attacks.PUNCH, Attacks.BULLET_SPRAY], sprite=Image("images/characters/copguy/copguy.png"), ai = AIType.NEUTRAL, display_name = "Copguy", portrait=Image("gui/rpg/portraits/copguy.png"), custom_health_bar = "hp_bar_police", custom_health_string = "???")
    ...
    COPGUY_EXE = Character("{image=gui/inline_text/dx_text.png} Copguy.EXE", 666, 66, 66, [Attacks.ELDRITCH_BLAST, Attacks.RAINBOW_VOMIT, Attacks.SLASH, Attacks.LIFE_STEAL], sprite=Image("images/characters/copguy/copguyexe.png"), ai = AIType.AGGRO, display_name = "Copguy.EXE", portrait=Image("gui/rpg/portraits/copguy_exe.png"))
    ...
    TATE_EX = Character("{image=gui/inline_text/dx_text.png} Tate EX", 9999, 11, 111, [Attacks.DAMAGE_SCREM, Attacks.REVERB_RECALL, Attacks.ECHO_BLAST], sprite=Image("images/characters/tate/secret/tate_ex.png"), ai = AIType.AGGRO, display_name = "Tate EX", portrait=Image("gui/rpg/portraits/tate_ex.png"), anim_sprite="tate_ex", custom_health_bar = "hp_bar_secret_t")
