...
class Characters:
    ...
    TATE_EX = Character("{image=gui/inline_text/dx_text.png} Tate EX", 9999, 11, 111, [Attacks.DAMAGE_SCREM, Attacks.REVERB_RECALL, Attacks.ECHO_BLAST], sprite=Image("secret/pt/tate_ex.png"), ai = AIType.AGGRO, display_name = "Tate EX", portrait=Image("gui/rpg/portraits/tate_ex.png"), anim_sprite="tate_ex", custom_health_bar = "hp_bar_secret_t")
