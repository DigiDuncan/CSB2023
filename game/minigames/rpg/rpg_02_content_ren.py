...
class Characters:
    ...
    CS_STRONG = Character("CS (Strong)", 188, 10, 35, [Attacks.KICK, Attacks.BULLET_SPRAY], portrait=Image("gui/rpg/portraits/cs.png"), display_name = "CS", ai = AIType.NEUTRAL)
    CS_FINAL = Character("CS (Final)", 288, 10, 40, [Attacks.KICK, Attacks.BULLET_SPRAY, Attacks.YTP_MAGIC], portrait=Image("gui/rpg/portraits/cs.png"), display_name = "CS", ai = AIType.NEUTRAL)
    CS_FINAL2 = Character("CS (Error)", 1880, 10, 250, [Attacks.KICK, Attacks.YTP_HEAL, Attacks.YTP_MAGIC_NOCOOL], portrait=Image("gui/rpg/portraits/cs.png"), display_name = "CS", ai = AIType.NEUTRAL)
    CS_WEAK = Character("CS (Weak)", 188, 5, 25, [Attacks.PUNCH], portrait=Image("gui/rpg/portraits/cs.png"), display_name = "CS", ai = AIType.NEUTRAL)
    CS_ARCHIVAL = Character("CS (Archival)", 1027, 50, 27, [Attacks.KICK, Attacks.YTP_HEAL], portrait=Image("gui/rpg/portraits/cs.png"), display_name = "CS", ai = AIType.NEUTRAL)
    CS_VS_TATE_PUNCH = Character("{image=gui/inline_text/dx_text.png} CS (VS Tate - Punch)", 288, 10, 40, [Attacks.PUNCH, Attacks.GENERGY, Attacks.YTP_MAGIC], portrait=Image("gui/rpg/portraits/cs.png"), display_name = "CS", ai = AIType.NEUTRAL)
    CS_VS_TATE_KICK = Character("{image=gui/inline_text/dx_text.png} CS (VS Tate - Kick)", 288, 10, 40, [Attacks.KICK, Attacks.GENERGY, Attacks.YTP_MAGIC], portrait=Image("gui/rpg/portraits/cs.png"), display_name = "CS", ai = AIType.NEUTRAL)
    CS_VS_TATE_CHOP = Character("{image=gui/inline_text/dx_text.png} CS (VS Tate - Chop)", 288, 10, 40, [Attacks.CHOP, Attacks.GENERGY, Attacks.YTP_MAGIC], portrait=Image("gui/rpg/portraits/cs.png"), display_name = "CS", ai = AIType.NEUTRAL)
