...
class Characters:
    ...
    # Allies
    CS = Character("CS", 188, 10, 25, [Attacks.PUNCH, Attacks.BULLET_SPRAY], portrait=Image("gui/rpg/portraits/cs.png"), sprite=Image("images/characters/cs/base/angry.png"))
    ...
    CS_VS_TATE_PUNCH = Character("{image=gui/inline_text/dx_text.png} CS (VS Tate - Punch)", 288, 10, 40, [Attacks.PUNCH, Attacks.GENERGY, Attacks.YTP_MAGIC], portrait=Image("gui/rpg/portraits/cs.png"), display_name = "CS")
    ...
    BLANK = Character("Blank", 180, 5, 35, [Attacks.SAMPLE_BLAST, Attacks.GNOMED], portrait=Image("gui/rpg/portraits/blank_hover.png"), sprite=Image("images/characters/blank.png"))
    MIDGE = Character("Midge", 165, 10, 25, [Attacks.NUDGE, Attacks.DRAW_IN], portrait=Image("gui/rpg/portraits/midge.png"), sprite=Image("images/characters/midge.png"))
    DB05 = Character("DB05", 9001, 9001, 50, [Attacks.CONFIDENCE, Attacks.PEP_TALK], portrait=Image("gui/rpg/portraits/db05.png"), sprite=Image("images/characters/db.png"))
    ANNO = Character("Anno", 200, 20, 40, [Attacks.RADS_ATTACK, Attacks.AI_MIMIC], portrait=Image("gui/rpg/portraits/anno.png"), sprite=Image("images/characters/anno/anno.png"))

    # Allies (UCN)
    BUBBLE = Character("{image=gui/inline_text/dx_text.png} Bubble", 250, 10, 35, [Attacks.STOMP, Attacks.POKE], display_name = "Bubble", portrait=Image("gui/rpg/portraits/bubble.png"), sprite=Image("images/characters/bubble.png"))
    GES = Character("{image=gui/inline_text/dx_text.png} Ges", 170, 20, 35, [Attacks.SWORD_SLASH, Attacks.FLAMETHROWER], display_name = "Ges", portrait=Image("gui/rpg/portraits/ges.png"), sprite=Image("images/characters/ges.png"))
    MICHAEL = Character("Michael", 155, 15, 35, [Attacks.CHOCOLATE_CAKE, Attacks.CONFUSING_STORY], portrait=Image("gui/rpg/portraits/michael.png"), sprite=Image("images/characters/michael.png"))
    BILLY = Character("Billy", 220, 10, 25, [Attacks.HYPE_UP, Attacks.PITCHMAN, Attacks.AUGMENT], portrait=Image("gui/rpg/portraits/billy.png"), sprite=Image("images/characters/billy/BillyMaysWithLaser.png"))
    PHIL = Character("Phil", 160, 20, 40, [Attacks.HYPE_UP, Attacks.PITCHMAN], portrait=Image("gui/rpg/portraits/phil.png"), sprite=Image("images/characters/phil.png"))
    MEAN = Character("Mean", 150, 20, 35, [Attacks.HUG, Attacks.SPIKE_BOMB], portrait=Image("gui/rpg/portraits/mean.png"), sprite=Image("images/characters/mean/meanangry.png"))
    POMNI = Character("Pomni", 200, 15, 30, [Attacks.RAINBOW_VOMIT_NOCOOL, Attacks.RAINBOW_VOMIT_NOCOOL], portrait=Image("gui/rpg/portraits/pomni.png"), sprite=Image("images/characters/pomni/pomni_concern.png"))
    OBAMA = Character("{image=gui/inline_text/dx_text.png} Obama", 190, 25, 35, [Attacks.KARATE_CHOP, Attacks.DRONE_STRIKE], portrait=Image("gui/rpg/portraits/obama.png"), sprite=Image("images/characters/obama/obama.png"))
    CASHIER = Character("{image=gui/inline_text/dx_text.png} Cashier", 188, 14, 33, [Attacks.COIN_BARRAGE, Attacks.CART_SMASH], portrait=Image("gui/rpg/portraits/cashier.png"), sprite=Image("images/characters/cashier.png"))
    SHARK = Character("{image=gui/inline_text/dx_text.png} Shark", 190, 10, 40, [Attacks.BITE, Attacks.SHARKNADO], portrait=Image("gui/rpg/portraits/shark.png"), sprite=Image("images/characters/blahaj_shark.png"))
