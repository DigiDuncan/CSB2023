...
class Fighter:
    def __init__(self, name: str, enemy: bool, hp: int, ap: int, atk: int, attacks: list[Attack | ComboAttack], sprite: Displayable = None, multiplier: float = 1, ai: AI = None, display_name: str = None):
        self.name = name
        self.enemy = enemy
...
class Fighters:
    ...
    # Allies
    CS = Fighter("CS", False, 188, 10, 25, [Attacks.PUNCH, Attacks.BULLET_SPRAY], Image("gui/rpg/portraits/cs.png"), display_name = "CS")
    CS_NG = Fighter("CS (National Guard)", False, 188, 10, 30, [Attacks.CHOP, Attacks.BULLET_SPRAY], Image("gui/rpg/portraits/cs.png"), display_name = "CS")
    CS_STRONG = Fighter("CS (Strong)", False, 188, 10, 35, [Attacks.KICK, Attacks.BULLET_SPRAY], Image("gui/rpg/portraits/cs.png"), display_name = "CS")
    CS_FINAL = Fighter("CS (Final)", False, 288, 10, 40, [Attacks.KICK, Attacks.BULLET_SPRAY, Attacks.YTP_MAGIC], Image("gui/rpg/portraits/cs.png"), display_name = "CS")
    CS_FINAL2 = Fighter("CS (Error)", False, 1880, 10, 250, [Attacks.KICK, Attacks.YTP_HEAL, Attacks.YTP_MAGIC_NOCOOL], Image("gui/rpg/portraits/cs.png"), display_name = "CS")
    CS_WEAK = Fighter("CS (Weak)", False, 188, 5, 25, [Attacks.PUNCH], Image("gui/rpg/portraits/cs.png"), display_name = "CS")
    CS_ARCHIVAL = Fighter("CS (Archival)", False, 1027, 50, 27, [Attacks.KICK, Attacks.YTP_HEAL], Image("gui/rpg/portraits/cs.png"), display_name = "CS")
    CS_VS_TATE_PUNCH = Fighter("CS (VS Tate - Punch)", False, 288, 10, 40, [Attacks.PUNCH, Attacks.GENERGY, Attacks.YTP_MAGIC], Image("gui/rpg/portraits/cs.png"), display_name = "CS")
    CS_VS_TATE_KICK = Fighter("CS (VS Tate - Kick)", False, 288, 10, 40, [Attacks.KICK, Attacks.GENERGY, Attacks.YTP_MAGIC], Image("gui/rpg/portraits/cs.png"), display_name = "CS")
    CS_VS_TATE_CHOP = Fighter("CS (VS Tate - Chop)", False, 288, 10, 40, [Attacks.CHOP, Attacks.GENERGY, Attacks.YTP_MAGIC], Image("gui/rpg/portraits/cs.png"), display_name = "CS")
    ARCEUS = Fighter("Arceus", False, 160, 15, 35, [Attacks.SLASH, Attacks.LIGHT_CAST], Image("gui/rpg/portraits/arceus.png"))
    PAKOO = Fighter("Pakoo", False, 145, 20, 30, [Attacks.INSIGHT, Attacks.SHOTGUN], Image("gui/rpg/portraits/pokoo.png"))
    MIKA = Fighter("Mika", False, 165, 20, 30, [Attacks.ENCOURAGE, Attacks.HIGH_NOON], Image("gui/rpg/portraits/mika.png"))
    KITTY = Fighter("Kitty", False, 155, 15, 20, [Attacks.SCRATCH, Attacks.ARMOUR], Image("gui/rpg/portraits/kitty.png"))
    TATE = Fighter("Tate", False, 170, 5, 30, [Attacks.DAMAGE_SCREM, Attacks.SNACK_TIME], Image("gui/rpg/portraits/tate.png"))
    ARIA = Fighter("Aria", False, 220, 20, 45, [Attacks.ELDRITCH_BLAST, Attacks.RAINBOW_VOMIT], Image("gui/rpg/portraits/aria.png"))
    DIGI = Fighter("Digi", False, 150, 20, 30, [Attacks.ROBOPUNCH, Attacks.HOLOSHIELD], Image("gui/rpg/portraits/digi.png"))
    NOVA = Fighter("Nova", False, 170, 5, 30, [Attacks.MUSIC_BOOST, Attacks.RAVE], Image("gui/rpg/portraits/nova.png"))
    BLANK = Fighter("Blank", False, 180, 5, 35, [Attacks.SAMPLE_BLAST, Attacks.GNOMED], Image("gui/rpg/portraits/blank.png"))
    MIDGE = Fighter("Midge", False, 165, 10, 25, [Attacks.NUDGE, Attacks.DRAW_IN], Image("gui/rpg/portraits/midge.png"))
    DB05 = Fighter("DB05", False, 9001, 9001, 50, [Attacks.CONFIDENCE, Attacks.PEP_TALK], Image("gui/rpg/portraits/db05.png"))
    ANNO = Fighter("Anno", False, 200, 20, 40, [Attacks.RADS_ATTACK, Attacks.AI_MIMIC], Image("gui/rpg/portraits/anno.png"))

    # Allies (UCN)
    BUBBLE = Fighter("{image=gui/dx_text.png} Bubble", False, 250, 10, 35, [Attacks.STOMP, Attacks.POKE], display_name = "Bubble")
    GES = Fighter("{image=gui/dx_text.png} Ges", False, 170, 20, 35, [Attacks.SWORD_SLASH, Attacks.FLAMETHROWER], display_name = "Ges")
    MICHAEL = Fighter("Michael", False, 155, 15, 35, [Attacks.CHOCOLATE_CAKE, Attacks.CONFUSING_STORY])
    BILLY = Fighter("Billy", False, 220, 10, 25, [Attacks.HYPE_UP, Attacks.PITCHMAN, Attacks.AUGMENT])
    PHIL = Fighter("Phil", False, 160, 20, 40, [Attacks.HYPE_UP, Attacks.PITCHMAN])
    MEAN = Fighter("Mean", False, 150, 20, 35, [Attacks.HUG, Attacks.SPIKE_BOMB])
    POMNI = Fighter("Pomni", False, 200, 15, 30, [Attacks.RAINBOW_VOMIT_NOCOOL, Attacks.RAINBOW_VOMIT_NOCOOL])
    OBAMA = Fighter("{image=gui/dx_text.png} Obama", False, 190, 25, 35, [Attacks.KARATE_CHOP, Attacks.DRONE_STRIKE])
    CASHIER = Fighter("{image=gui/dx_text.png} Cashier", False, 188, 14, 33, [Attacks.COIN_BARRAGE, Attacks.CART_SMASH])
    SHARK = Fighter("{image=gui/dx_text.png} Shark", False, 190, 10, 40, [Attacks.BITE, Attacks.SHARKNADO])
    ...
    COPGUYGODMODE = Fighter("Copguy (God)", True, 9001, 9001, 35, [Attacks.PUNCH, Attacks.BULLET_SPRAY], Image("images/characters/copguy/copguy.png"), ai = AIType.NEUTRAL, display_name = "Copguy")
    COPGUY = Fighter("Copguy", True, 300, 20, 35, [Attacks.PUNCH, Attacks.BULLET_SPRAY], Image("images/characters/copguy/copguy.png"), ai = AIType.NEUTRAL)
    ...
    COPGUY_EX = Fighter("Copguy EX", True, 2222, 30, 50, Attacks.ex_attacks, Image("images/characters/copguy/copguy.png"), ai = AIType.COPGUY_EX)
    ...
    COPGUY_EXE = Fighter("{image=gui/dx_text.png} Copguy.EXE", True, 666, 66, 66, [Attacks.ELDRITCH_BLAST, Attacks.RAINBOW_VOMIT, Attacks.SLASH, Attacks.CONFUSING_STORY], Image("images/characters/copguy/copguyexe.png"), ai = AIType.AGGRO, display_name = "Copguy.EXE")
...
class DamageIndicator:
    ...
    def play(self):
        if self.indicator_type == "heal":
            renpy.sound.play("audio/sfx/snd_power.ogg", channel = "sfx")
            self.play_sound = False
        elif self.indicator_type == "damage":
            renpy.sound.play("audio/sfx/snd_damage.ogg", channel = "sfx")
            self.play_sound = False
        elif self.indicator_type == "dot":
            renpy.sound.play("audio/sfx/sfx_hurt1.ogg", channel = "sfx")
            self.play_sound = False
        elif self.indicator_type == "stat_up":
            renpy.sound.play("audio/sfx/snd_b.ogg", channel = "sfx")
            self.play_sound = False
        elif self.indicator_type == "stat_down" or self.indicator_type == "miss":
            renpy.sound.play("audio/sfx/snd_bluh.ogg", channel = "sfx")
            self.play_sound = False
        elif self.indicator_type == "confused" or self.indicator_type == "unconfused":
            renpy.sound.play("audio/sfx/snd_chime.ogg", channel = "sfx")
            self.play_sound = False
