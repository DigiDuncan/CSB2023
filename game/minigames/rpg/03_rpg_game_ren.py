...
class Attacks:
    ...
    ECHO_BLAST = ComboAttack("Echo Blast", "Make them feel the pain of the past, at the cost of your ATK.", [TATE_ECHOES, TATE_BLAST], cooldown = 10, accuracy = 100, used = True, ex = False)
