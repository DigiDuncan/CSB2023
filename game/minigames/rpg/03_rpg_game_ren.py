...
class Fighters:
    ...
    CS_VS_TATE_PUNCH = Fighter("CS (VS Tate - Punch)", False, 288, 10, 40, [Attacks.PUNCH, Attacks.GENERGY, Attacks.YTP_MAGIC], Image("images/characters/cs/neutral.png"), display_name = "CS")
    CS_VS_TATE_KICK = Fighter("CS (VS Tate - Kick)", False, 288, 10, 40, [Attacks.KICK, Attacks.GENERGY, Attacks.YTP_MAGIC], Image("images/characters/cs/neutral.png"), display_name = "CS")
    CS_VS_TATE_CHOP = Fighter("CS (VS Tate - Chop)", False, 288, 10, 40, [Attacks.CHOP, Attacks.GENERGY, Attacks.YTP_MAGIC], Image("images/characters/cs/neutral.png"), display_name = "CS")
    ...
    POMNI = Fighter("Pomni", False, 200, 15, 30, [Attacks.RAINBOW_VOMIT_NOCOOL, Attacks.RAINBOW_VOMIT_NOCOOL], Image("images/characters/pomni/pomni.png"))
