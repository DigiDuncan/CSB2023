...
label rpg_ucn:
    ...
    $ party_1 = renpy.display_menu([(a, a) for a in ["NONE"] + Fighters.ally_names], screen="ucn_choice")
    $ narrator("Choose a party member! (2/4)", interact = False)
    $ party_2 = renpy.display_menu([(a, a) for a in ["NONE"] + Fighters.ally_names], screen="ucn_choice")
    $ narrator("Choose a party member! (3/4)", interact = False)
    $ party_3 = renpy.display_menu([(a, a) for a in ["NONE"] + Fighters.ally_names], screen="ucn_choice")
    $ narrator("Choose a party member! (4/4)", interact = False)
    $ party_4 = renpy.display_menu([(a, a) for a in ["NONE"] + Fighters.ally_names], screen="ucn_choice")

    $ narrator("Choose an enemy! (1/3)", interact = False)
    $ enemy_1 = renpy.display_menu([(a, a) for a in ["NONE"] + Fighters.enemy_names], screen="ucn_choice")
    $ narrator("Choose an enemy! (2/3)", interact = False)
    $ enemy_2 = renpy.display_menu([(a, a) for a in ["NONE"] + Fighters.enemy_names], screen="ucn_choice")
    $ narrator("Choose an enemy! (3/3)", interact = False)
    $ enemy_3 = renpy.display_menu([(a, a) for a in ["NONE"] + Fighters.enemy_names], screen="ucn_choice")
