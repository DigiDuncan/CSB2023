...
init python:
    ...
    def char_callback(event, name = None, beep = None, play_beeps = True, **kwargs):
        ...
        if preferences.text_beeps and play_beeps:
            if event == "show":
                if beep is not None:
                    renpy.sound.play(f"audio/text/{beep}.flac", channel = "beep", loop = True)
                else:
                    renpy.sound.play(f"audio/text/ut.flac", channel = "beep", loop = True)
    ...
    window id "start_window" xalign 0.5 yalign 0.5:
        vbox xalign 0.5 yalign 0.5:
            ...
            hbox xalign 0.5 yalign 0.5:
                spacing 50
                imagebutton auto "menu/csbi_%s.png" hover_sound "sfx_select.flac":
                    at transform:
                        zoom 0.666
                    action Play("sound", "sfx_valid.flac"), Hide("chapter_menu", Fade(1.0)), Jump("csbi_start")
                imagebutton auto "menu/csbii_%s.png" hover_sound "sfx_select.flac":
                    sensitive persistent.csb2_unlocked
                    at transform:
                        zoom 0.666
                    action Play("sound", "sfx_valid.flac"), Hide("chapter_menu", Fade(1.0)), Jump("csbii_start")
                imagebutton auto "menu/csbiii1_%s.png" hover_sound "sfx_select.flac":
                    sensitive persistent.csb3a_unlocked
                    at transform:
                        zoom 0.666
                    action Play("sound", "sfx_valid.flac"), Hide("chapter_menu", Fade(1.0)), Jump("csbiii_start")
                imagebutton auto "menu/csbiii2_%s.png" hover_sound "sfx_select.flac":
                    sensitive persistent.csb3b_unlocked
                    at transform:
                        zoom 0.666
                    action Play("sound", "sfx_valid.flac"), Hide("chapter_menu", Fade(1.0)), Jump("choose_direction")
