...
image nu_finish = "nu_finish.png"
image nu_finish sil_black = "sil_black:nu_finish.png"
...
# Movies
image car background = Movie(play="movies/car_background.webm", channel = "music")
image car background night = Movie(play="movies/car_background_night.webm", channel = "music")
image car plains = Movie(play="movies/car_plains.webm", channel = "music")
image car plains night = Movie(play="movies/car_plains_night.webm", channel = "music")
image tvcar = Movie(play="movies/0001.webm", channel = "music")
image drive_night = Movie(play="movies/car_drive_night.webm", channel = "music")
image drive_day = Movie(play="movies/car_drive_day.webm", channel = "music")
image csb1tube = Movie(play="movies/csb1.webm", channel = "music")
image train_start = Movie(play="movies/train_start.webm", channel = "music")
image train_in_tunnel = Movie(play="movies/train_in_tunnel.webm", channel = "music")
image train_outside_tunnel = Movie(play="movies/train_outside_tunnel.webm", channel = "music")
image train_loop = Movie(play="movies/train_loop.webm", channel = "music")
image the_tram = Movie(play="movies/the_tram.webm", channel = "music")
image sign_closeup = Movie(play="movies/sign_closeup.webm", channel = "music")
image karaoke = Transform(Movie(play = "movies/karaoke.webm", side_mask = True, channel = "music"), zoom = 1.5)
image bad_end_screen = Transform(Movie(play = "movies/bad_ending.webm", side_mask = True, loop=False, image="images/fail_end.png", channel = "music"), size=(1920,1080))
image bronson_hell = Movie(play="movies/bronsonhell.webm", channel = "music")
image fun_cs_house = Movie(play="movies/funvaluecshouse.webm", channel = "music")
image fun_hoh_sis = Movie(play="movies/funvaluehohsis.webm", channel = "music")
image train_brake = Movie(play="movies/trainscreech.webm", channel = "music")
