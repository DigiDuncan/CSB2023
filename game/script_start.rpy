...
image karaoke = Transform(Movie(play = "movies/karaoke.webm", side_mask = True), zoom = 1.5, channel = "music")
image bad_end_screen = Transform(Movie(play = "movies/bad_ending.webm", side_mask = True, loop=False, image="images/fail_end.png"), size=(1920,1080), channel = "music")
