...
define k174 = Character("K17-4", callback = renpy.partial(char_callback, name = "k174", beep = "k17"))
define k199 = Character("K19-9", callback = renpy.partial(char_callback, beep = "k19"))
define k207 = Character("K20-7", callback = renpy.partial(char_callback, beep = "k20"))
...
define audio.sfx_chug_that = "sfx/sfx_chug_that.ogg"
