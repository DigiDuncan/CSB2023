...
define k19 = Character("K-19", callback = char_callback)
define orville = Character("Orville Wright", callback = char_callback)
define wilbur = Character("Wilbur Wright", callback = char_callback)
define booger = Character("Mucinex Booger", callback = char_callback)
