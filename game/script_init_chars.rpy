...
define worker_1_beach = Character("Customer", callback = char_callback)
...
define tate_cyan = Character("Tate?", callback = renpy.partial(char_callback, beep = "tate_cyan")) # no auto-unlock on purpose

# Cpt. Underpants is not here because he has no spoken lines
define david = Character("David", callback = renpy.partial(char_callback, name = "david"))
define george = Character("George", callback = renpy.partial(char_callback, name = "george"))
define harold = Character("Harold", callback = renpy.partial(char_callback, name = "harold"))
define mr_krupp = Character("Mr. Krupp", callback = renpy.partial(char_callback, name = "mr_krupp"))
define weird_al = Character("Weird Al", callback = renpy.partial(char_callback, name = "weird_al"))
