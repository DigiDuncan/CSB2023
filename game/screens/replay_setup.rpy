...
init python:
    ...
    Replay_items.append(ReplayItem(["Brag"], "true_braghohsis", "{outlinecolor=#000000}{color=#FF0000}RIP Money{/color}{/outlinecolor}"))
    ...
    Replay_items.append(ReplayItem(["GodFail"], "genocide_attack_arc", "{outlinecolor=#000000}{color=#FF0000}God Fail{/color}{/outlinecolor}"))
    Replay_items.append(ReplayItem(["GodSuccess"], "genocide_wait_arc", "{outlinecolor=#000000}{color=#FF0000}God Success{/color}{/outlinecolor}"))
    ...
    Replay_items.append(ReplayItem(["BadDriver"], "true_lose_car_game", "{outlinecolor=#000000}{color=#FF0000}Bad Driver{/color}{/outlinecolor}"))
    Replay_items.append(ReplayItem(["PencilShart"], "true_lose_pencil_game", "{outlinecolor=#000000}{color=#FF0000}Pencil Sharting Day!{/color}{/outlinecolor}"))
    ...
    Replay_items.append(ReplayItem(["CopCall"], "true_true_ending", "{outlinecolor=#000000}{color=#AA00CC}True Ending{/color}{/outlinecolor}"))
