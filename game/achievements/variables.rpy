...
define achievements = [
    ...
    Achievement("Master Chef", "???", "Win over Gordan Ramsay.", "masterchef", "story"),
    ...
    Achievement("Boingy Boingy Boingy", "???", "Max out CSBounciness and beat the game.", "max_bounce", "extra"),
    ...
    Achievement("For Poop And For Glory", "Remind them of who the main character is.", "Defeat Tate EX.", "vs-tate", "extra", dx = True),
