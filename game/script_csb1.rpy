...
label start:
    ...
    cs "..."
    cs "I know! Should watch some other YTPs for inpiration"
    show craptop_yt
    hide craptop_edit
    ...
    "{i}A loud crash can be heard as though an atom has split in CSs foundation{/i}"
    ...
    ed "CS surrrrreeee loves those cute catgirls~ <3"
