...
translate tok_sitelen_lasina strings:
    ...
    old "Return to Menu"
    new "o tawa e lipu monsi"

    # game/screens.rpy:521
    old "Main Menu"
    new "o tawa lipu lawa"
    ...
    new "{bt=a3-p10-s1}sina jan Sijesu anu seme? o luka e ni!"
    ...
    new "nanpa musi [config.version!t]\n"
    ...
    new "o lukin ala e nimi pi lukin ala"

    # game/screens.rpy:1090
    old "Skip After Choices"
    new "o lukin ala e ken"
    ...
    new "o sona awen e weka\n{size=-12}sona li weka tawa tenpo ale."

    # game/screens.rpy:1314
    old "Clear Save Slots\n{size=-12}Clears all the save slots. This cannot be undone."
    new "o poki sona e weka\n{size=-12}poki sona li weka tawa tenpo ale."
    ...
    new "o pana e ijo suli tawa lipu."
