...
label interstate_69:
    ...
    arceus "Oh for f- whatever, just get us out of here!"
    ...
    arceus "Weren't you the already scared going into this?"
    ...
    cs "I didn't mean to change, I just meant- wait, what's that up ahead?"
