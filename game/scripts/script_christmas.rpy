...
label dx_christmas_intro:
    ...
    eliza "I've experienced some harsh Russian winters, but I've never heard anything this bad before."
    ...
    n "CS pulls and yanks and the door, until it finally rips open."
    ...
    mean "As Mean yanks on the hatch, it bursts open downwards, as a huge pile of snow falls into the attic floor."
