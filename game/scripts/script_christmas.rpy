...
label ce_anno:
    ...
    if tree_first:
        ...
        show cs coat disappointed at offscreenleft
        show cs coat disappointed at mid_mid_left with moveinleft
        ...
        show cs coat disappointed at mid_mid_left with moveinleft
    pause 0.5
    show cs coat disappointed at right with move
    pause 0.5
    cs "Here we go."

    show cs coat disappointed at mid_offscreen_right with move
    show shovel at manual_pos(1.2, 0.8, 0.5) with determination
    $ collect("shovel")

    show cs coat disappointed at right 
    ...
    pause 0.5
    show cs coat disappointed flipped at left 
    ...
    show cs coat disappointed flipped at right
    show shovel at manual_pos(0.9, 0.7, 0.5):
        rotate 15
    with dissolve
    play music snowy
    ...
    show cs coat disappointed flipped at center
    ...
    show cs coat disappointed at center
    ...
    show cs coat disappointed flipped at mid_right
    ...
    show cs coat disappointed flipped at mid_left
    ...
    show cs coat worried at offscreenright
...
label ce_roof_moment:
    ...
    cs "{image=note_small1.png} You better watch out I'm telling you why... {image=note_small2.png}"
    ...
    k17 "{image=note_small1.png} He's checking it twice... {image=note_small2.png}"
    grace "{image=note_small1.png} He's gonna find out if you've been naughty or nice... {image=note_small2.png}"
    rich "{image=note_small1.png} Santa Claus is coming, to town! {image=note_small2.png}"
    tate "{image=note_small1.png} He knows when you are sleeping... {image=note_small2.png}"
    ...
    obama "{image=note_small1.png} So, you better be good. For goodness sake! {image=note_small2.png}"
    cs "{image=note_small1.png} Ohhh... {image=note_small2.png}"
