...
label ce_party_before:
    ...
    # TODO: if we add anyone else, let's use one of these numbers and save 21 for something funnier
...
label ce_lights_out:
    ...
    # POINT AND CLICK LABELS HAVE MOVED TO MINIGAMES FOLDER
...
label ce_roof_moment:
    ...
    show anno festive sil_black at Move((0.53, 0.33), (0.32, 0.48), 3, repeat=False, bounce=False, xanchor="left", yanchor="top")
