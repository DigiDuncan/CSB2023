...
label vegas:
    ...
    hide arceus dark
    with moveoutright
    n "CS and Arc enter the casino. It looks like chaos is unfolding in front of their faces."
...
label airport:
    ...
    show arceus flipped at mid_left
    with moveinleft
    n "CS and Arc put their luggage on the conveyor and walk through the scanner."
