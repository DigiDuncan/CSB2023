label archival:
    ...
    n "CS jumps over the chair next to him and hides between the chair and the couch in the corner of the room."
    ...
    show cs worried at left with moveinleft
    n "A blue car is sitting out the driveway."
    ...
    show cs worried at left with moveinleft
    n "The interior of the car is drastically different from the outside, and thankfully the car starts up."
    scene csmart_old with fade
    show cs worried at left with moveinleft
    n "CS starts to drive off, but he is instantly teleported to a WalMart that poorly has a \"CS\" pasted onto the sign."
