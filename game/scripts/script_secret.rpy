label secret_ce:
    ...
    digi "You aren't supposed to be here."
    digi "But since you {i}are{/i} here... I guess it means there's a bug in the game."
    ...
    digi "Well, you got an achievement for it, so that's something!"
