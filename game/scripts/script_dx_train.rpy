...
label train_enter_sleeper:
    ...
    play sound "audio/sfx_sliding_door_close.ogg"
    ...
    show arceus worried
    with shake2
    play sound "audio/sfx_hard_knock.ogg"
    ...
    play sound "audio/sfx_sliding_door_open.ogg"
    pause 1.0
...
label train_meanwhile:
    ...
    play sound "sfx_sliding_door_open.ogg"
    n "The cab door suddenly opens from behind."
    show lupin hat flipped at left
    show amtrak_conductor at right
    with moveinright
    play sound "sfx_sliding_door_close.ogg"
    ...
    play sound "sfx_sliding_door_close.ogg"
    pause 4.0
    play sound "sfx_fart_with_reverb.ogg"
    with hpunch
    with hpunch
    with hpunch
    pause 1.5
