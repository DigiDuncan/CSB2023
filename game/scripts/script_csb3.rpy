...
label south:
    ...
    n "The Minifigure eyes glow as it raises it's arms up and starts running at CS."
    lego "HEEYYYY!!!!!"
...
label vegas:
    ...
    n "As they enter Las Vegas and find a place to park, the start by heading down The Strip."
